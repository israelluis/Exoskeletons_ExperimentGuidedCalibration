...
peak_force = 140;         % Peak force (N)
moment_arm = 0.107;        % Moment arm length (m)

% Calculate peak torque
peak_torque = peak_force * moment_arm; % Torque in Nm
...
xlabel('Gait Cycle (%)');
ylabel('Torque (Nm)');
title('Assistive Torque Profile Using Force and Moment Arm');
grid on;
