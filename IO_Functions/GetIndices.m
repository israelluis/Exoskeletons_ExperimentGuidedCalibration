...
Misc.coupled_EMGscale = zeros(size(Misc.Coupled_EMG_scaling)); % israel
...
% added coupling of tendon stiffness
...
for i=1:Misc.nTrials
    ...
    DatStore(i).coupled_EMGscale = zeros([size(Misc.Coupled_EMG_scaling) 3]); %israel
